...
{
    public class NavbarEntertainmentArticlesViewComponent : ViewComponent
    {
        private readonly IArticleService _articleService;
        private readonly ICategoryService _categoryService;

        public NavbarEntertainmentArticlesViewComponent(IArticleService articleService, ICategoryService categoryService)
        {
        ...
        public IViewComponentResult Invoke()
        {
            ...
            var categoryId = _categoryService.GetCategories().Where(c => c.Name == "Entertainment").FirstOrDefault().Id;
